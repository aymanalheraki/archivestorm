...
TFDQuery* SelectQ(AnsiString strSql,TFDConnection *connDB)
{
	try
	{
	 ...
	 {
		ShowMessage("There is a problem in connection with Database");
	 }
	 return 0;
}
...
{
	Application->MessageBoxA(str1.w_str(), L"Caution message",MB_ICONQUESTION);
}
