...
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall GetXPThemeColor(Vcl::Controls::TControl* Control, TRzXPThemeColor Element);
extern DELPHI_PACKAGE TRzXPColorScheme __fastcall GetXPColorScheme(void);
extern DELPHI_PACKAGE void __fastcall GetGradientSelectionColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &FrameColor, System::Uitypes::TColor &StartColor, System::Uitypes::TColor &StopColor);
extern DELPHI_PACKAGE void __fastcall GetGradientPanelColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &StartColor, System::Uitypes::TColor &StopColor);
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall GetGradientPanelFrameColor(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle);
extern DELPHI_PACKAGE void __fastcall GetGradientStatusBarColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &StartColor, System::Uitypes::TColor &StopColor, System::Uitypes::TColor &DividerColor);
extern DELPHI_PACKAGE void __fastcall GetGradientGroupBarColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &StartColor, System::Uitypes::TColor &StopColor);
extern DELPHI_PACKAGE void __fastcall GetGradientCategoryGroupColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, bool SpecialGroup, System::Uitypes::TColor &CaptionBackColor, System::Uitypes::TColor &CaptionBackColorStart, System::Uitypes::TColor &CaptionBackColorStop, System::Uitypes::TColor &CaptionFontColor, System::Uitypes::TColor &CaptionFontHotColor, System::Uitypes::TColor &CaptionButtonColor, System::Uitypes::TColor &CaptionButtonBorderColor, System::Uitypes::TColor &CaptionDividerColor, System::Uitypes::TColor &GroupColor, System::Uitypes::TColor &GroupBorderColor);
extern DELPHI_PACKAGE void __fastcall GetGradientOutlookGroupColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &CaptionBackStartColor, System::Uitypes::TColor &CaptionBackStopColor, System::Uitypes::TColor &CaptionFontColor, System::Uitypes::TColor &CaptionFontHotColor, System::Uitypes::TColor &GroupStartColor, System::Uitypes::TColor &GroupStopColor);
extern DELPHI_PACKAGE void __fastcall GetGradientGroupItemColors(Vcl::Controls::TControl* Control, TRzGradientColorStyle ColorStyle, System::Uitypes::TColor &ItemFontColor, System::Uitypes::TColor &ItemFontHotColor);
extern DELPHI_PACKAGE Vcl::Themes::TCustomStyleServices* __fastcall ActiveStyleServices(Vcl::Controls::TControl* Control);
extern DELPHI_PACKAGE bool __fastcall UsingSystemStyle(Vcl::Controls::TControl* Control);
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall ActiveStyleSystemColor(Vcl::Controls::TControl* Control, System::Uitypes::TColor C);
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall ActiveStyleColor(Vcl::Controls::TControl* Control, Vcl::Themes::TStyleColor SC);
extern DELPHI_PACKAGE bool __fastcall UseActiveStyleColor(Vcl::Controls::TControl* Control);
extern DELPHI_PACKAGE System::Uitypes::TColor __fastcall ActiveStyleFontColor(Vcl::Controls::TControl* Control, Vcl::Themes::TStyleFont SF);
extern DELPHI_PACKAGE bool __fastcall UseActiveStyleFontColor(Vcl::Controls::TControl* Control);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawCtl3DBorder(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, bool Lowered);
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawCtl3DBorderSides(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, bool Lowered, TSides Sides);
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawButtonBorder(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, bool Lowered);
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawButtonBorderSides(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, bool Lowered, TSides Sides);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawBorder(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TFrameStyle Style);
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawBorderSides(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TFrameStyle Style, TSides Sides);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall DrawInnerOuterBorders(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TFrameStyleEx BorderOuter, TFrameStyleEx BorderInner, int BorderWidth, TSides BorderSides, int BevelWidth, System::Uitypes::TColor BorderColor, System::Uitypes::TColor BorderHighlight, System::Uitypes::TColor BorderShadow, System::Uitypes::TColor FlatColor, int FlatColorAdjustment, System::Uitypes::TColor Color, System::Uitypes::TColor ParentColor, bool Transparent, bool SoftInnerFlatBorder = false);
extern DELPHI_PACKAGE void __fastcall DrawGroupBarBackground(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TRzVisualStyle VisualStyle, TRzGradientColorStyle ColorStyle, TRzGroupBarGradientPath GradientPath, System::Uitypes::TColor CustomStartColor, System::Uitypes::TColor CustomStopColor);
extern DELPHI_PACKAGE void __fastcall DrawLEDBar(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TOrientation Orientation, System::Uitypes::TColor BarColor, System::Uitypes::TColor BackColor, int NumSegments, int Percent, bool ThemeAware, bool Transparent);
...
extern DELPHI_PACKAGE void __fastcall DrawFrame(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, int Width, int Height, TFrameStyle FrameStyle, System::Uitypes::TColor EraseColor, System::Uitypes::TColor FrameColor, TSides FrameSides, bool Transparent = false);
...
extern DELPHI_PACKAGE void __fastcall DrawDropDownArrow(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TRzUIStyle UIStyle, bool Down, bool Enabled = true, float AScaleFactor = 1.000000E+00f);
extern DELPHI_PACKAGE void __fastcall DrawArrowImage(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, System::Uitypes::TColor AColor, TDirection ADirection, bool ASmallSize, float AScaleFactor = 1.000000E+00f);
extern DELPHI_PACKAGE void __fastcall DrawSpinArrow(Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, System::Uitypes::TColor Color, System::Uitypes::TColor DisabledColor, TDirection Direction, bool Down, bool SmallSize, bool Enabled = true, float ScaleFactor = 1.000000E+00f)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawSpinArrow(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TRzUIStyle UIStyle, TDirection Direction, bool Down, bool SmallSize, bool Enabled = true, float ScaleFactor = 1.000000E+00f)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawCloseX(Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, System::Uitypes::TColor Color, bool Down, bool Enabled = true, float ScaleFactor = 1.000000E+00f)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawCloseX(Vcl::Controls::TControl* Control, Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &Bounds, TRzUIStyle UIStyle, bool Down, bool Enabled = true, float ScaleFactor = 1.000000E+00f)/* overload */;
