...
// (DO NOT EDIT: machine generated header) 'AdvSmoothEddd.pas' rev: 35.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ADVSMOOTHEDDD)
