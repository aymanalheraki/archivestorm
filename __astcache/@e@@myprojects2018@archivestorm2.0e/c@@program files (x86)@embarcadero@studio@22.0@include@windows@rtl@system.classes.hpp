...
public:
	...
	void __fastcall AddStrings(const System::UnicodeString *Strings, const int Strings_High)/* overload */;
	void __fastcall AddStrings(const System::UnicodeString *Strings, const int Strings_High, System::TObject* const *Objects, const int Objects_High)/* overload */;
	virtual void __fastcall Assign(TPersistent* Source);
