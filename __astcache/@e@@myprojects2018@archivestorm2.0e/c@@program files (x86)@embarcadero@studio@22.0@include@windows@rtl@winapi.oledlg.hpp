...
// (DO NOT EDIT: machine generated header) 'Winapi.OleDlg.pas' rev: 35.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef unsigned __stdcall (*TFNOleUIHook)(HWND Wnd, unsigned Msg, NativeUInt AWParam, NativeInt ALParam);
