...
private:
	...
	Vcl::Virtualimagelist::TVirtualImageList* FInternalImages;
...
private:
	...
	void __fastcall LoadInternalImage(Vcl::Buttons::TBitBtnKind AValue);
...
private:
	...
	int __fastcall GetArrowRegionWidth();
