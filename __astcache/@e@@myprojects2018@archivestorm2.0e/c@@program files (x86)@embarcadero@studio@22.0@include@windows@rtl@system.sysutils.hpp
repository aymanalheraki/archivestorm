...
class DELPHICLASS EInOutArgumentException;
...
public:
	...
	__fastcall EInOutError(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */;
	__fastcall EInOutError(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */;
public:
...
public:
	/* EInOutError.Create */ inline __fastcall EPathTooLongException(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */ : EInOutError(Msg, Path) { }
	/* EInOutError.CreateRes */ inline __fastcall EPathTooLongException(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */ : EInOutError(ResStringRec, Path) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EPathTooLongException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EInOutError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EPathTooLongException(NativeUInt Ident)/* overload */ : EInOutError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EPathTooLongException(System::PResStringRec ResStringRec)/* overload */ : EInOutError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EPathTooLongException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPathTooLongException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EPathTooLongException(const System::UnicodeString Msg, int AHelpContext) : EInOutError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EPathTooLongException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EInOutError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPathTooLongException(NativeUInt Ident, int AHelpContext)/* overload */ : EInOutError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPathTooLongException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EInOutError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPathTooLongException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPathTooLongException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* EInOutError.Create */ inline __fastcall EDirectoryNotFoundException(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */ : EInOutError(Msg, Path) { }
	/* EInOutError.CreateRes */ inline __fastcall EDirectoryNotFoundException(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */ : EInOutError(ResStringRec, Path) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EDirectoryNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EInOutError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EDirectoryNotFoundException(NativeUInt Ident)/* overload */ : EInOutError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EDirectoryNotFoundException(System::PResStringRec ResStringRec)/* overload */ : EInOutError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EDirectoryNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EDirectoryNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EDirectoryNotFoundException(const System::UnicodeString Msg, int AHelpContext) : EInOutError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EDirectoryNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EInOutError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDirectoryNotFoundException(NativeUInt Ident, int AHelpContext)/* overload */ : EInOutError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDirectoryNotFoundException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EInOutError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDirectoryNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDirectoryNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* EInOutError.Create */ inline __fastcall EFileNotFoundException(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */ : EInOutError(Msg, Path) { }
	/* EInOutError.CreateRes */ inline __fastcall EFileNotFoundException(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */ : EInOutError(ResStringRec, Path) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EFileNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EInOutError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFileNotFoundException(NativeUInt Ident)/* overload */ : EInOutError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EFileNotFoundException(System::PResStringRec ResStringRec)/* overload */ : EInOutError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EFileNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFileNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EFileNotFoundException(const System::UnicodeString Msg, int AHelpContext) : EInOutError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EFileNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EInOutError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFileNotFoundException(NativeUInt Ident, int AHelpContext)/* overload */ : EInOutError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFileNotFoundException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EInOutError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFileNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFileNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* EInOutError.Create */ inline __fastcall EPathNotFoundException(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */ : EInOutError(Msg, Path) { }
	/* EInOutError.CreateRes */ inline __fastcall EPathNotFoundException(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */ : EInOutError(ResStringRec, Path) { }
	
public:
	/* Exception.CreateFmt */ inline __fastcall EPathNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EInOutError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EPathNotFoundException(NativeUInt Ident)/* overload */ : EInOutError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EPathNotFoundException(System::PResStringRec ResStringRec)/* overload */ : EInOutError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EPathNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPathNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EInOutError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EPathNotFoundException(const System::UnicodeString Msg, int AHelpContext) : EInOutError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EPathNotFoundException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EInOutError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPathNotFoundException(NativeUInt Ident, int AHelpContext)/* overload */ : EInOutError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPathNotFoundException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EInOutError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPathNotFoundException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPathNotFoundException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EInOutError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	System::UnicodeString Path;
	__fastcall EInOutArgumentException(const System::UnicodeString Msg, const System::UnicodeString Path)/* overload */;
	__fastcall EInOutArgumentException(System::PResStringRec ResStringRec, const System::UnicodeString Path)/* overload */;
public:
	/* Exception.CreateFmt */ inline __fastcall EInOutArgumentException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EArgumentException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInOutArgumentException(NativeUInt Ident)/* overload */ : EArgumentException(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EInOutArgumentException(System::PResStringRec ResStringRec)/* overload */ : EArgumentException(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EInOutArgumentException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EArgumentException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInOutArgumentException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EArgumentException(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EInOutArgumentException(const System::UnicodeString Msg, int AHelpContext) : EArgumentException(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EInOutArgumentException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EArgumentException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInOutArgumentException(NativeUInt Ident, int AHelpContext)/* overload */ : EArgumentException(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInOutArgumentException(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : EArgumentException(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInOutArgumentException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EArgumentException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInOutArgumentException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : EArgumentException(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EInOutArgumentException() { }
