...
namespace System
{
    ...
    typedef unsigned short       WordBool;         //
    typedef int                  LongBool;         //
  #if defined(_WIN64) || (defined(_DELPHI_WEAK_NATIVEINT) && (defined(_PLAT_IOS64) || defined(_PLAT_LINUX64) || defined(_PLAT_MACOS64) || defined(_PLAT_ANDROID64)))
    typedef __int64              NativeInt;        //
    typedef unsigned __int64     NativeUInt;       //
  #elif (defined(_PLAT_MSWINDOWS) || defined(_PLAT_MACOS32) || defined(_DELPHI_WEAK_NATIVEINT))
 ...
 #define _INIT_UNIT(unitName)   \
  ...
  #if !defined(_DELPHI_NEXTGEN) || defined(_Windows) || defined(_DELPHI_WEAK_NATIVEINT)
