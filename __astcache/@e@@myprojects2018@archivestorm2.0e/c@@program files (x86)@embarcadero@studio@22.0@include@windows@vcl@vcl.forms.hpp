...
// (DO NOT EDIT: machine generated header) 'Vcl.Forms.pas' rev: 35.00 (Windows)
...
enum DECLSPEC_DENUM TVCLDesignerHighDPIMode : unsigned char { hdmUnknown, hdmAutoScale, hdmLowDPI, hdmUserEditable };
